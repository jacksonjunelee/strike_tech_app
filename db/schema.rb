...
ActiveRecord::Schema.define(version: 20150818223116) do
  ...
  create_table "engines", primary_key: "engineName", force: :cascade do |t|
    ...
    t.binary   "integer", limit: 32, null: false
  end
  ...
  add_index "usertoengines", ["user_id"], name: "usertoengines_toUser_idx", using: :btree
  ...
  add_foreign_key "usertoengines", "users", primary_key: "idusers", name: "toUser", on_update: :cascade, on_delete: :nullify
end
